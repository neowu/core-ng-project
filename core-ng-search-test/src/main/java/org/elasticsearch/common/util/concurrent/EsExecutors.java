...
// TODO: remove once https://github.com/elastic/elasticsearch/pull/104347 released
@SuppressFBWarnings()
...
public class EsExecutors {
    ...
    static class ExecutorScalingQueue<E> extends LinkedTransferQueue<E> {
        @Serial
        private static final long serialVersionUID = -2545195061037902623L;

        transient ThreadPoolExecutor executor;
