public class TestWebServiceImpl$getEnum implements core.framework.web.Controller {
    ...
    public core.framework.web.Response execute(core.framework.web.Request request) throws Exception {
        Long $id = core.framework.impl.web.service.PathParamParser.toLong(request.pathParam("id"));
        core.framework.impl.web.service.TestWebService.TestEnum $enum = (core.framework.impl.web.service.TestWebService.TestEnum)core.framework.impl.web.service.PathParamParser.toEnum(request.pathParam("enum"), core.framework.impl.web.service.TestWebService.TestEnum.class);
