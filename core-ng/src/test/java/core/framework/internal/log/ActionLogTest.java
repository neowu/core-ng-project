...
class ActionLogTest {
    ...
    @Test
    void track() {
        assertThat(log.track("db", 1000, 1, 0, 0, 0)).isEqualTo(1);
        ...
        assertThat(log.track("db", 1000, 1, 1, 0, 0)).isEqualTo(2);
        ...
        assertThat(log.track("http", 3000, 0, 0, 1000, 2000)).isEqualTo(1);
