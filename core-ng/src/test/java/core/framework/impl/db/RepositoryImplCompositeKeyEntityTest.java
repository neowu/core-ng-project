...
public class RepositoryImplCompositeKeyEntityTest {
    ...
    public void insert() {
        ...
        CompositeKeyEntity selectedEntity = repository.get("id1", "id2").get();
    ...
    public void batchDelete() {
        ...
        repository.batchDelete(Lists.newArrayList(new Object[]{"1-1", "1-2"}, new Object[]{"2-1", "2-2"}));

        Assert.assertFalse(repository.get("1-1", "1-2").isPresent());
        Assert.assertFalse(repository.get("2-1", "2-2").isPresent());
    }
}