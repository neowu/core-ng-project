...
public class GroovyScriptEngineService extends AbstractComponent implements ScriptEngineService {
    ...
    public GroovyScriptEngineService(Settings settings) {
        ...
        this.loader = AccessController.doPrivileged(new GroovyClassLoaderPrivilegedAction(sm, config));
    }
    ...
    static class BigDecimalExpressionTransformer extends ClassCodeExpressionTransformer {
        ...
        BigDecimalExpressionTransformer(SourceUnit source) {
            this.source = source;
        }
    ...
    private class GroovySearchScript implements SearchScript {
        ...
        public GroovySearchScript(SearchLookup lookup, Map<String, Object> vars, CompiledScript compiledScript) {
            this.lookup = lookup;
            this.vars = vars;
            this.compiledScript = compiledScript;
        }
