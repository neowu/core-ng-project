 ...
 * @author allison
 */
public class ActionFlowAJAXServiceImplV1 implements ActionFlowAJAXService {
    ...
    public ActionFlowResponseV1 actionFlowV1(String actionId) {
        ...
        var response = new ActionFlowResponseV1();
    ...
    private ActionFlowResponseV1.Node nodeInfo(ActionDocument actionDocument) {
        var node = new ActionFlowResponseV1.Node();
    ...
    private ActionFlowResponseV1.Edge firstEdgeInfo(ActionDocument actionDocument, int i) {
        String startPoint = format(START_POINT, i);
        var edge = new ActionFlowResponseV1.Edge();
    ...
    private List<ActionFlowResponseV1.Edge> edgeInfo(ActionDocument actionDocument) {
        List<ActionFlowResponseV1.Edge> edges = new ArrayList<>(actionDocument.refIds.size());
    ...
    private String nodeColor(ActionDocument actionDocument, boolean isRequestedAction) {
        if (actionDocument.stats.get("cpu_time") > 30000000000L)
            return "red";
    ...
    private String edgeStyle(ActionDocument actionDocument) {
        ...
        if (actionType == ActionType.HANDLER || actionType == ActionType.EXECUTOR)
            return "dashed";
        if (actionDocument.elapsed > 30000000000L)
            return "bold";
        return "solid";
    }
